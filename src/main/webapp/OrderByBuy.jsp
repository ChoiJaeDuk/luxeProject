			...
			<div class="container">
				<div id='con'>
					<div id='product_info'>
						<!-- 컨테이너 -->
						<div id='product-img'>
							<img src="${path}/img/${goodsDTO.goodsImagesDTO.goodsMainImg}" />
						</div>
						...
						<div id='price-list'>
							<div class='price01' id='pri01'>
								<p id='title'>즉시 구매가</p>
								<span id='price-now'><fmt:formatNumber
										value="${goodsDTO.lowestPrice}" pattern="#,###" /></span><span
									id='won'>원</span>
							</div>
							<div class='price01'>
								<p id='title'>즉시 판매가</p>
								<span id='price-now'><fmt:formatNumber
										value="${goodsDTO.highestPrice}" pattern="#,###" /></span><span
									id='won'>원</span>
							</div>
						</div>
					</div>
					...
					<div id='order-tap'>
						...
						<div id="buy-type01">
							<div id='price'>
								...
								<div id='price-con'>
									<input type="text" id='input-amount' placeholder="희망가 입력" /> <span
										id='won02'>원</span>
								</div>
							</div>
							<div id='price-total'>
						...
						<div id="buy-type02">
							<div id='price'>
								...
								<div id='price-con'>
									<span id='price02'>${goodsDTO.lowestPrice}</span> <span
										id='won02'>원</span>
								</div>
							</div>
							<div id='price-total'>
