		...
		$.ajax({
			...
			success :function(result){
				...
				$.each(result, function(index, item){
					...
					str+=`<td>${"${item.regisGoodsBrand}"}</th>`;
					str+=`<td>${"${item.regisGoodsName}"}</th>`;
...
<body>
	<div id="mySidebar" class="sidebar">
		...
		<a href="../Manager02/Manager_Member.jsp">회원관리</a> <a href="#">상품관리</a> <a href="../Manager02/Manager_Orders.jsp">주문현황</a> 
		<a href="../Manager02/Manager_Sales.jsp">매출현황</a> <a href="#">문의관리</a><a href="ManagerApproval.jsp">상품승인관리</a>
	</div>
	<div id='wrap'>
