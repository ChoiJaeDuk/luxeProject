...
<body>
	<div id='header'>
		...
		<div id='header-bottom'>
			<div class="topnav">
				<div id='logo' onclick="location.href='${path}/layout/index.jsp';">LUXE</div>
				<a href="${path}/layout/index.jsp">HOME</a> <a href="${pageContext.request.contextPath}/style/StyleBoard.jsp">STYLE</a> <a href="${pageContext.request.contextPath}/shop/shop.jsp">SHOP</a>
				<div class="split">
