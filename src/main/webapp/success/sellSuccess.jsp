		...
		<div id='contents'>
			...
			<div class='con'>
				<div class="col-lg-8 col-lg-offset-2 text-center" style="margin: 0 auto; position: relative; top: 100px;">
					...
					<p class="lead text-muted"style="font-family: 'Noto Sans KR', sans-serif; font-weight: 500; font-size: 24px;">
					판매신청완료되었습니다♥
					</p>
							...
							<div class="col-lg-6  col-lg-offset-3" style="margin: 0 auto;">
								<div class="btn-group btn-group-justified">
									 <a
										...
										class="btn btn-success"  style="background-color: #222222;border:2px solid #ffffff;">HOME</a>
								</div>
